 ...
 * as a stacked bar with a small numeric counter.
 * ──────────────────────────────────────────────────────────────────────────── */
...
function BrazilAtAGlance() {
  ...
  return (
    <figure aria-label="Brazil at a glance: coverage by PIR dimension">
      ...
      <h3 className="mt-3 font-display text-[26px] font-extrabold leading-[1.1] tracking-tightest text-brand-ink">
      ...
      <dl className="mt-7 space-y-4">
        {rows.map((r) => (
          <div key={r.dim} className="grid grid-cols-12 items-center gap-3">
            ...
            <dd className="col-span-7 flex h-4 w-full overflow-hidden rounded-[1px] bg-brand-rule">
            ...
            <dd className="col-span-1 text-right font-sans text-[14px] tabular-nums text-brand-ink/70">
      ...
      <div className="mt-8 border-t border-brand-rule pt-5 grid grid-cols-3 gap-6 font-sans">
        <div>
          <div className="font-display text-[32px] font-extrabold leading-none tabular-nums text-brand-deep">
            {totalCells}
          </div>
          <div className="mt-2 eyebrow-ink text-brand-ink/65">Mapped cells</div>
        </div>
        <div>
          <div className="font-display text-[32px] font-extrabold leading-none tabular-nums text-brand-deep">
            {totalGreen}
          </div>
          <div className="mt-2 eyebrow-ink text-brand-ink/65">Strong</div>
        </div>
        <div>
          <div className="font-display text-[32px] font-extrabold leading-none tabular-nums text-brand-deep">
            8&nbsp;×&nbsp;6
          </div>
          <div className="mt-2 eyebrow-ink text-brand-ink/65">
            Sub-sectors&nbsp;×&nbsp;dim.
          </div>
        </div>
      </div>

      <figcaption className="figure-caption mt-6">
        <strong>Source</strong>&nbsp;·&nbsp;Brazil country profile (this tool), 2026.
        Each bar shows the 8 mapped WSS and WRM sub-sectors, split by coverage
        status.
      </figcaption>
    </figure>
  );
      ...
      <section className="relative isolate overflow-hidden bg-brand-teal text-brand-ink">
        ...
        <div className="mx-auto grid min-h-[78vh] max-w-[88rem] grid-cols-12 items-end gap-8 px-8 pb-16 pt-32">
          <div className="col-span-12 md:col-span-7">
            ...
            <h1 className="display-hero mt-6 text-[clamp(42px,6.4vw,84px)]">
              Water reform starts
              <br />
              with the law.
            </h1>
            <p className="prose-editorial mt-7 max-w-[36rem] text-[22px] italic text-brand-ink/85">
              This tool maps every water-sector law, regulator and mandate to
              the World Bank Group's WSIP&nbsp;×&nbsp;PIR framework. Find the
              gap, cite the source, brief the minister.
            </p>
            <div className="mt-10 flex flex-wrap items-baseline gap-6 font-serif italic">
              <Link
                to="/country/BRA"
                className="text-[22px] font-medium text-brand-ink underline decoration-brand-ink/40 decoration-2 underline-offset-[8px] transition-colors hover:text-brand-ink hover:decoration-brand-ink"
              >
                Begin with Brazil&nbsp;→
              </Link>
              <Link
                to="/wsip-matrix"
                className="text-[18px] text-brand-ink/70 underline decoration-brand-ink/20 underline-offset-[6px] hover:text-brand-ink hover:decoration-brand-ink/60"
              >
      ...
      <section className="bg-white">
        <div className="mx-auto grid max-w-[88rem] grid-cols-12 gap-12 px-8 py-24">
          <div className="col-span-12 md:col-span-6">
            ...
            <h2 className="mt-3 font-display text-[clamp(28px,3.4vw,42px)] font-extrabold leading-[1.06] tracking-tightest text-brand-ink">
              Who governs water, and where the law is silent.
            </h2>

            <div className="prose-editorial mt-7 max-w-[36rem] text-[19px]">
              <p>
              ...
              <p>
                ...
                the de&#8209;facto note that records what is actually happening
                on the ground.
              </p>
            </div>
            ...
            <blockquote className="pull-quote mt-10 border-l-2 border-brand-amber pl-6">
              ...
              <span className="mt-3 block not-italic text-[13px] font-semibold uppercase tracking-[0.18em] text-brand-ink/55">
          ...
          <div className="col-span-12 md:col-span-6">
            ...
            <div className="mt-8 border-t border-brand-rule pt-5">
              <Link
                ...
                className="link-editorial font-display text-[16px] font-semibold tracking-[0.04em]"
              >
        ...
        <div className="mx-auto max-w-[88rem] px-8 py-24">
          <div className="grid grid-cols-12 gap-12">
            <div className="col-span-12 md:col-span-8">
              ...
              <p className="prose-editorial mt-5 max-w-[38rem] text-[18px]">
          ...
          <div className="mt-10 border border-brand-rule bg-white p-3">
            <WorldMap />
          </div>
        </div>
      </section>
      ...
      <section className="bg-brand-ink text-white">
        <div className="mx-auto grid max-w-[88rem] grid-cols-12 items-center gap-8 px-8 py-20">
          <div className="col-span-12 md:col-span-8">
            ...
            <h2 className="mt-4 font-display text-[clamp(30px,4vw,54px)] font-extrabold leading-[1.05] tracking-tightest text-white">
          ...
          <div className="col-span-12 md:col-span-4 md:text-right">
            <Link
              to="/wizard"
              className="font-serif italic text-[22px] text-brand-teal underline decoration-brand-teal/40 decoration-2 underline-offset-[8px] hover:text-white hover:decoration-white"
            >
              Open the wizard&nbsp;→
            </Link>
          </div>
